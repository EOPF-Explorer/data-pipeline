...
- Sentinel-3 OLCI L1 EFR (Ocean/Land Colour radiances — `sentinel-3-olci-l1-efr-staging`, staging only; see [claude-docs/specs/s3_olci_pipeline_runbook.md](claude-docs/specs/s3_olci_pipeline_runbook.md))
